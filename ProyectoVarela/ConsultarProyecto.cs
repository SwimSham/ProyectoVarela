    ...
    public partial class ConsultarProyecto : Form
    {
        ...
        public void DatosMateriales()
        {
            using (SqlConnection conexion = new SqlConnection("Data Source=GWNR71517;Initial Catalog=laminadoVarela;Integrated Security=True"))
            {
                ...
                string consulta = "SELECT Nombre_Proyecto, NomCliente, MP.Id_Material, MP.Cantidad_Necesaria, M.MATERIAL, M.TIPO, " +
        ...
        public void DatosHerramientas()
        {
            using (SqlConnection conexion = new SqlConnection("Data Source=GWNR71517;Initial Catalog=laminadoVarela;Integrated Security=True"))
            {
                ...
                string consulta = "SELECT Nombre_Proyecto, NomCliente, HP.Id_Herramienta, HP.Cantidad_Necesaria, H.NOMBRE, H.TIPOHERRAMIENTAS," +
